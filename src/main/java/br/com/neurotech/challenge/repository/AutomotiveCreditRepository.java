...
@Repository
public interface AutomotiveCreditRepository extends JpaRepository<AutomotiveCredit, Long> {

  @Query("""
          SELECT cr
            FROM AutomotiveCredit cr
           WHERE (:model     IS NULL OR cr.vehicleModel = :model)
